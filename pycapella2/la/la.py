...
from pycapella2.capellacommon import AbstractCapabilityPkg, CapabilityRealizationInvolvedElement
from pycapella2.cs import ArchitectureAllocation, BlockArchitecturePkg, Component, ComponentArchitecture, ComponentPkg, InterfaceAllocation
