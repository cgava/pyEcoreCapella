...
from pycapella2.capellacore import AbstractDependenciesPkg, AbstractExchangeItemPkg, Allocation, CapellaElement, Classifier, GeneralClass, InvolvedElement, Involvement, InvolverElement, ModellingArchitecturePkg, ModellingBlock, NamedElement, Relationship, Structure
from pycapella2.information.communication import CommunicationLinkExchanger, CommunicationLinkProtocol, MessageReferencePkg
from pycapella2.fa import AbstractFunctionalArchitecture, AbstractFunctionalBlock, ComponentExchangeAllocator
from pycapella2.information import AbstractEventOperation, AbstractInstance, Port, Property
from pycapella2.modellingcore import FinalizableElement, InformationsExchanger
