...
from pycapella2.modellingcore import AbstractConstraint, AbstractNamedElement, AbstractRelationship, AbstractTrace, AbstractType, AbstractTypedElement, FinalizableElement, PublishableElement, TraceableElement
