...
from pycapella2.behavior import AbstractSignal
from pycapella2.capellacore import CapellaElement, Classifier, Relationship, Structure, VisibilityKind
from pycapella2.information.datavalue import DataValueContainer
...
# Inheritance definition for SignalInstance moved in root package initialization
# to fix circular imports with AbstractInstance
