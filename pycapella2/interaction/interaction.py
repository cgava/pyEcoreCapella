...
from pycapella2.capellacore import Allocation, CapellaElement, Involvement, InvolverElement, NamedElement, NamedRelationship, Namespace, Relationship, Structure, Trace
from pycapella2.fa import AbstractFunctionalChainContainer
